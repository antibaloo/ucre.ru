...
<div class="new-big-block">
    ...
    <div class="new-big-body">
        <div class="new-data active" id="data1">
            <table>
					<tr>
						<td><?=$arItem['PROPERTIES']['REGION']['NAME']?></td>
						<td><?=$arItem['PROPERTIES']['REGION']['VALUE']?></td>
					</tr>
        ...
        <div class="new-data " id="data2">
            <div class="tov-addr" data-addr="<?=htmlspecialcharsbx($arItem['PROPERTIES']['REGION']['VALUE'].', '.$arItem['PROPERTIES']['CITY']['VALUE'].', '.$arItem['PROPERTIES']['ADDRESS']['VALUE'])?>"><?=$arItem['PROPERTIES']['ADDRESS']['VALUE']?></div>
            <div id="map"></div>
        </div>
