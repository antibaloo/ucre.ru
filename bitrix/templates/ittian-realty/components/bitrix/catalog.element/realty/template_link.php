    ...
    <div class="left-card">
        <div class="tovsl-wrap">
            ...
            <ul class="tov-slider">
                ...
                <?}?>
                <?if($arPictures = $arItem['PROPERTIES']['PHOTOS']['VALUE']){?>
                    <?foreach($arPictures as $picture){?>

                        <li><a class="fnc" rel="al"><img src="<?=$picture?>" /></a></li>
                    <?}?>
                <?}?>
            </ul>
        ...
        <div id="bx-pager">
            <div class="bx-p">
                ...
                <?$i=1;foreach($arPictures as $picture){?>
                    ...
                    <a data-slide-index="<?=$i++?>" href=""><img height='72' width='104' src="<?=$picture?>" /></a>
                <?}?>
            </div>
        </div>
        <?}?>
...
<div class="new-big-block">
    <div class="new-big-thumbs">
        ...
        <a class="nw-map " oncl ick="displayMap()" data-item="data2"><span><?=GetMessage('CE_TAB_3')?></span></a>
    </div>
...
<sc ript src="https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false"></sc ript>
<sc ript type="text/javascript" src="<?=SITE_TEMPLATE_PATH?>/assets/js/infoBox.js"></sc ript>
