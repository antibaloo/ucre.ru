...
$arIBlockType_realty = CIBlockParameters::GetIBlockTypes();

$arIBlock_realty = array();
$rsIBlock = CIBlock::GetList( array("sort" => "asc"), array("TYPE" => $arCurrentValues["REALTY_IBLOCK_TYPE"], "ACTIVE" => "Y") );
while( $arr = $rsIBlock->Fetch() ){
    $arIBlock_realty[$arr["ID"]] = "[".$arr["ID"]."] ".$arr["NAME"];
}
...
$arTemplateParameters = array(
    ...
    "REALTY_IBLOCK_TYPE" => array(
        "SORT" => 660,
        "NAME" => GetMessage("REALTY_IBLOCK_TYPE"),
        "TYPE" => "LIST",
        "VALUES" => $arIBlockType_realty,
        "REFRESH" => "Y",
    ),
    "REALTY_IBLOCK_ID" => array(
        "SORT" => 670,
        "NAME" => GetMessage("REALTY_IBLOCK_ID"),
        "TYPE" => "LIST",
        "VALUES" => $arIBlock_realty,
        "REFRESH" => "Y",
        "ADDITIONAL_VALUES" => "Y",
    )
);
