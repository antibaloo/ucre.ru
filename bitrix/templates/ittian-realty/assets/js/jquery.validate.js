...
$.extend($.validator, {
	...
	messages: {
		...
		number: "Пожалуйста введите правильные числа.",
		digits: "Пожалуйста введите только цифры.",
		creditcard: "Пожалуйста введите правильный номер кредитной карты.",
		equalTo: "Пожалуйста введите номер ещё раз.",
		maxlength: $.validator.format("Пожалуйста введите не более чем {0} букв."),
		minlength: $.validator.format("Пожалуйста введите не менее  {0} букв."),
		rangelength: $.validator.format("Пожалуйста, введите значение между {0} и {1}."),
		range: $.validator.format("Пожалуйста, введите значение между {0} and {1}."),
